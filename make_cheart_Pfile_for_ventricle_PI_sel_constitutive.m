function make_cheart_Pfile_for_ventricle_PI_sel_constitutive(sim_folder_dir,incr_num,dp_dt,material_law,material_parameters,patchID_Endo,patchID_Epi,patchID_Base,patchID_Apex,flag_prescr_bound_base,flag_prescr_bound_epi,flag_prescr_bound_endo,flag_prescr_bound_apex_hole,flag_prescr_APEX_NODE,flag_disc_Fib,flag_fix_base,flag_fix_apex_hole,Nodes_per_elem_dir)
...
%     end
    ...
    if isempty(dp_dt)==0
        coun_patches_TU=1; % afou exw LV pressure     
    end
    if flag_prescr_bound_base==1
        if Nodes_per_elem_dir==4
